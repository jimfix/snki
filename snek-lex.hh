...
//    * eat_name, eat_number, eat_string, eat_operator, eat_EOF, eat_EOLN
// The current token (next to be consumed) can be queried with
//    * current, at (to look for a match)
//    * at_name, at_number, at_string, at_operator, at_EOF, at_EOLN
//
class TokenStream {    
private:
    std::string src_name;
